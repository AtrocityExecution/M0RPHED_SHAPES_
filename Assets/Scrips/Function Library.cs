...
public static class FunctionLibrary
{
    ...
    public enum FunctionName { Wave, MultiWave, Ripple, ScalingSphere, TwistedSphere, SpindleTorus, RingTorus, TwistedTorus, Experimental }

    static Function[] functions = { Wave, MultiWave, Ripple, ScalingSphere, TwistedSphere, SpindleTorus, RingTorus, TwistedTorus, Experimental };
    ...
    public static Vector3 Experimental(float u, float v, float t)
    {
        float r1 = 0.7f + 0.1f * Sin(PI * (6f * u + 0.5f * t));
